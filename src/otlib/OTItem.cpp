...
void OTItem::GetStringFromType(OTItem::itemType theType, OTString & strType)
{
	switch (theType)
	{
		...
		case OTItem::withdrawVoucher:
			...
			break;
                case OTItem::bailment:
			strType.Set("bailment");
			break;
		case OTItem::atBailment:
			strType.Set("atBailment");
			break;
		case OTItem::outbailment:
			strType.Set("outbailment");
			break;
		case OTItem::atOutbailment:
			strType.Set("atOutbailment");
			break;

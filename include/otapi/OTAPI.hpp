...
//	EXPORT static bool & Cleanup();
	...
	*/
	...
	EXPORT static time64_t      Instrmnt_GetValidFrom      (const std::string & THE_INSTRUMENT);
	EXPORT static time64_t      Instrmnt_GetValidTo        (const std::string & THE_INSTRUMENT);

...
public:
	...
	*/
    ...
    EXPORT virtual std::string GetNym_ActiveCronItemIDs(const std::string & NYM_ID, const std::string & SERVER_ID);
    EXPORT virtual std::string GetActiveCronItem(const std::string & SERVER_ID, int64_t lTransNum);
